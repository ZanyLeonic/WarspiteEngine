...
def ExportMap(pWorkingDir=None, pMapFile=None, pBaseFolder=None):
    ...
    if (pMapFile is None): 
        ...
        mapFile = Path(pMapFile)

    if (pBaseFolder is None): 
